...
class UIFunctions(MainWindow):
	...
	def maximize_restore(self):
		...
		if status == 0:
			...
			self.ui.drop_shadow_frame.setStyleSheet("background-color: rgb(221, 221, 221); border-radius: 0px;")
			...
			self.ui.drop_shadow_frame.setStyleSheet("background-color: rgb(221, 221, 221); border-radius: 10px;")
